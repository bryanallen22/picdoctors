...
(function($){
  ...
  reveal: 0.5
      ...
      return this.each(function() {
        ...
        var im1 = i.children('img:eq(0)');
        var im2 = i.children('img:eq(1)');
        var attr_width = im1.attr('width');
        var attr_height = im1.attr('height');
        var attr_width2 = im2.attr('width');
        var attr_height2 = im2.attr('height');
        var width = Math.max(attr_width, attr_width2);
        var height = Math.max(attr_height, attr_height2);
        ...
        i.children('.ba-mask').css('background-repeat','no-repeat');
        i.children('.ba-bg').css('backgroundImage','url(' + img_bg + ')');	
        i.children('.ba-bg').css('background-repeat','no-repeat');	
