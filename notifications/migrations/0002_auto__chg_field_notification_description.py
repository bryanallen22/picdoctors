...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Notification.description'
        db.alter_column(u'notifications_notification', 'description', self.gf('django.db.models.fields.CharField')(max_length=128))

    def backwards(self, orm):

        # Changing field 'Notification.description'
        db.alter_column(u'notifications_notification', 'description', self.gf('django.db.models.fields.CharField')(max_length=64))
