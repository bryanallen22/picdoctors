...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.fixed_payout_pct'
        db.add_column(u'common_profile', 'fixed_payout_pct',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.fixed_payout_pct'
        db.delete_column(u'common_profile', 'fixed_payout_pct')
