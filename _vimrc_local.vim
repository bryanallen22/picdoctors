...
map <silent> g* mZ:call setqflist([])<CR>*N:Ack --ignore-dir=django-docs --literal --word-regexp <cword><CR><CR>'Z:copen<CR>
map <silent> gc* mZ:call setqflist([])<CR>*N:Ack --ignore-dir=django-docs --css --literal --word-regexp <cword><CR><CR>'Z:copen<CR>
map <silent> gl* mZ:call setqflist([])<CR>*N:Ack --ignore-dir=django-docs --less --literal --word-regexp <cword><CR><CR>'Z:copen<CR>
