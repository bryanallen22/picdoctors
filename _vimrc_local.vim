...
map <silent> g* mZ:call setqflist([])<CR>*N:Ack --literal --word-regexp <cword> **/*<CR><CR>'Z:copen<CR>
map <silent> gc* mZ:call setqflist([])<CR>*N:Ack --css --literal --word-regexp <cword> **/*<CR><CR>'Z:copen<CR>
