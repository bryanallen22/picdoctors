...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BaseMessage.attachment'
        db.add_column(u'messaging_basemessage', 'attachment',
                      self.gf('django.db.models.fields.files.FileField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BaseMessage.attachment'
        db.delete_column(u'messaging_basemessage', 'attachment')
    ...
    models = {
        ...
        u'common.profile': {
            ...
            'accepted_eula': ('django.db.models.fields.BooleanField', [], {}),
