...
alias pddb='psql -h pd-production.c9b9prnejh0e.us-east-1.rds.amazonaws.com -p 5432 -U picdoctors -d picdoctors'
# Gracefully reload uwsgi and nginx
alias reload_app='kill -HUP `cat /tmp/supervisord.pid`'
